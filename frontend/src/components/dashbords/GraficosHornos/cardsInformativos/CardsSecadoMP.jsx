...
const CardsInformacion = () => {
  return (
    <div className="card text-white bg-warning mb-3" style={{ maxWidth: '20rem', borderRadius: '10px', margin: '0' }}>
    <div className="card-header text-center" style={{ borderRadius: '10px 10px 0 0', fontSize: '1.25rem' }}>Materia Prima</div>
